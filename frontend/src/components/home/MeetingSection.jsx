    ...
    <SectionWrapper id="online-meetings" className="bg-zinc-50/50 py-24">
      <div className="mb-16 text-center">
        ...
        <p className="text-zinc-500 max-w-2xl mx-auto text-lg leading-relaxed">
          Access virtual court sessions for the Appellate Tribunal and Regional
          Tribunals. Stay connected with legal proceedings from anywhere.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        ...
        >
          <div
            className={`absolute top-0 left-0 w-2 h-full bg-primary rounded-l-lg`}
          />
          ...
          <div className="p-8 md:p-12 flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start text-center md:text-left">
            <div className="relative flex-shrink-0">
              <div className="w-40 h-40 md:w-48 md:h-48 rounded-2xl overflow-hidden shadow-2xl border-4 border-zinc-100 group-hover:border-primary transition-colors duration-500">
                <img
            ...
            <div className="flex-1 space-y-6">
              <div>
                <span
                  className={`inline-block px-4 py-1.5 rounded-full text-xs font-black tracking-widest uppercase inline-flex items-center  rounded-full bg-primary/10 text-primary border border-primary/20 mb-4`}
                >
                  {dratDetails.name}
                </span>
              ...
              <div className="pt-2">
                <Button
                  ...
                  onClick={() =>
                    dratDetails.link && window.open(dratDetails.link, "_blank")
                  }
                  disabled={!dratDetails.link}
                >
                  <Video size={24} />
                  {dratDetails.link
                    ? "Join Appellate Hearing"
                    : "Link Not Available"}
                  {dratDetails.link && (
            ...
            >
              ...
              <div className="p-8 flex flex-col gap-6 items-center text-center">
                ...
                <div className="space-y-4 w-full">
                  <div>
                    <span
                      className={`inline-block px-3 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase bg-primary text-white mb-3`}
                    >
                      {court.name}
                    </span>
                  ...
                  <div className="pt-2">
                    <Button
                      ...
                      onClick={() =>
                        court.link && window.open(court.link, "_blank")
                      }
                      disabled={!court.link}
                    >
                      <Video size={18} />
